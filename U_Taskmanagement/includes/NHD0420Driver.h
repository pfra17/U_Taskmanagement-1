...
#define DISPLAY_QUEUE_DEPTH 5 //Queue Depth of Display Queue. The more vDisplayWriteStringAtPos calls you have between Display-Updates, the more Queue-Spots you need.
